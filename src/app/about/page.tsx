      ...
      <main className="bg-black text-white px-6 md:px-16 lg:px-24 py-24 space-y-11">
        ...
        >
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              vision. We emerged when the world needed a marketplace that dared
              to go where others wouldn’t — the underworld of innovation.
            </p>
          </div>
          <Image
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              At HelMarket, creativity isn’t a skill — it’s a ritual. We thrive
              in paradox: bold yet calculated, chaotic yet precise. We welcome
              all forms of expression, as long as they burn bright and true.
            </p>
          </div>
        </motion.section>
